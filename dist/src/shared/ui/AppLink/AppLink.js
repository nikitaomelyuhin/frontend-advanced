...
(function (AppLinkThemes) {
    ...
    AppLinkThemes["INVERTED"] = "inverted";
})(AppLinkThemes || (AppLinkThemes = {}));
export var AppLink = memo(function (props) {
    var className = props.className, to = props.to, children = props.children, _a = props.theme, theme = _a === void 0 ? AppLinkThemes.PRIMARY : _a, otherProps = __rest(props, ["className", "to", "children", "theme"]);
