...
export var LangSwitcher = function (props) {
    ...
    var changeLang = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return (_jsx("div", { className: classNames(cls.LangSwitcher, {}, [className]), children: _jsx(Button, { onClick: changeLang, theme: ButtonThemes.CLEAR, className: cls.button, children: short
                ? t('lang')
                : t('language') }) }));
};
