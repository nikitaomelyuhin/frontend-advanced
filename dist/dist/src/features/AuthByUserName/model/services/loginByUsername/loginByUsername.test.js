...
describe('loginByUsername', function () {
    test('success login', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            var userValue, thunk, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userValue = { username: '123', id: '1' };
                        mockedAxios.post.mockReturnValue(Promise.resolve({ data: userValue }));
                        thunk = new TestAyncThunk(loginByUsername);
                        return [4 /*yield*/, thunk.callThunk({ username: '123', password: '123' })];
                    case 1:
                        result = _a.sent();
